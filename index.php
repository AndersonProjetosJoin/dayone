...
<head>
    ...
    <title>Sistema Gerenciados de Contatos 1.0</title>
</head>
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <a href="#" class="navbar-brand">
                    <img src="./img/logo_contatos1.png" alt="Contatos" width="120">
                </a>
...
?>
    ...
    <footer class="container-fluid bg-dark text-light">
        <div class="text-center">Gerenciador de Contatos v 1.0 By Anderson de Carvalho Fernandes</div>
    </footer>
    <script src="./js/jquery.js"></script>
    <script src="./js/jquery.form.js"></script>
    <script src="./js/upload.js"></script>
    <script src="./js/javascript-contato.js"></script>
